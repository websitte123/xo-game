...
function winner()
{
    ...
    if(squars[1] == squars[2] && squars[2] == squars[3] && squars[1] != '')
    {
        ...
        document.getElementById('item' + 1).style.background='rgb(255, 0, 68)';
        document.getElementById('item' + 2).style.background='rgb(255, 0, 68)';
    ...
    else if(squars[4] == squars[5] && squars[5] == squars[6] && squars[4] != '')
    {
        ...
        document.getElementById('item' + 4).style.background='rgb(255, 0, 68)';
        document.getElementById('item' + 5).style.background='rgb(255, 0, 68)';
